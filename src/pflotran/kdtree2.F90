...
contains
  ...
  function kdtree2_create(input_data,dim,sort,rearrange) result (mr)
    ...
    print *, 'beginning allocating results'
...
!    write(*,*) 'Successfully passed dimension checks in kdtree2_create function, build tree next... (Debug Comment)'

    print *, 'beginning building tree'
    call build_tree(mr)
    !   write(*,*) 'Successfully passed build_tree in kdtree2_create function, sort and rearrange next... (Debug Comment)'
    ...
    subroutine build_tree(tp)
      ...
      !      write(*,*) 'Calling recursive function build_tree_for_range... (Debug Comment)'
      print *, 'assigning root'
...
!      write(*,*) 'Computing bounding box for node: ... (Debug Comment)'
...
!         write(*,*) 'Calling spread_in_coordinate... (Debug Comment)'
         !
