...
subroutine HydrostaticUpdateCoupler(coupler,option,grid)
  ...
  if (dabs(pressure_gradient(Z_DIRECTION)) < 1.d-40) then
    ...
    if (ipressure < 1) then
      ...
      call option%PrintErrMsgToDev('include your input deck')
    endif
