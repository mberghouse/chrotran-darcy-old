...
#include "petsc/finclude/petscsys.h"
  ...
  type, public, &
    ...
    PetscInt :: O2_id
	PetscInt :: CO2_id
	!PetscReal :: micro_motility   ! logical parameter to turn on or off microbial motility
  ...
  contains
    ...
    procedure, public :: Evaluate => ChrotranReact
    procedure, public :: UpdateKineticState => ChrotranKineticState
    procedure, public :: Destroy => ChrotranDestroy
  end type reaction_sandbox_chrotran_type

  public :: ChrotranCreate

contains

! ************************************************************************** !

function ChrotranCreate()
  !
  ...
  class(reaction_sandbox_chrotran_type), pointer :: ChrotranCreate

  allocate(ChrotranCreate)
  ChrotranCreate%name_D_mobile = ''
  ChrotranCreate%name_D_immobile = ''
  ChrotranCreate%name_C = ''
  ...
  ChrotranCreate%D_immobile_id = 0
  ChrotranCreate%C_id = 0
  ...
  !ChrotranCreate%micro_motility = 0.d0
  
  ChrotranCreate%stoichiometric_D_1 = 0.d0
  ChrotranCreate%rate_D = 0.d0
  ChrotranCreate%rate_C = 0.d0
  ChrotranCreate%inhibition_C = 0.d0
  ChrotranCreate%rate_B_2 = 0.d0
  ChrotranCreate%rate_B_1 = 0.d0
  ChrotranCreate%monod_D = 0.d0
  ChrotranCreate%inhibition_B = 0.d0
  ChrotranCreate%background_concentration_B = 0.d0
  ChrotranCreate%mass_action_CD = 0.d0
  ChrotranCreate%stoichiometric_C = 1.d0
  ChrotranCreate%stoichiometric_D_2 = 1.d0
  ChrotranCreate%rate_D_i = 0.d0
  ChrotranCreate%rate_D_m = 0.d0
  ChrotranCreate%exponent_B = 0.d0
  ChrotranCreate%inhibition_I = 0.d0
...
subroutine ChrotranRead(this,input,option)
  !
...
end subroutine ChrotranRead

! ************************************************************************** !

subroutine ChrotranSetup(this,reaction,option)
  !
...
end subroutine ChrotranSetup

! ************************************************************************** !

subroutine ChrotranReact(this,Residual,Jacobian,compute_derivative, &
...
end subroutine ChrotranReact

! ************************************************************************** !

subroutine ChrotranKineticState(this,rt_auxvar,global_auxvar, &
                                               material_auxvar, &
                                               reaction,option)
  !
...
end subroutine ChrotranKineticState

! ************************************************************************** !

subroutine ChrotranDestroy(this)
  !
...
end subroutine ChrotranDestroy

end module Reaction_Sandbox_Chrotran_class
